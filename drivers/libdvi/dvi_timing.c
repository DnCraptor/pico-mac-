...
// VESA DMT 800x600 @ 72 Hz. 1040 x 666 x 72.19 = 50.0 МГц
// bit_clk 500 МГц = clk_sys, divider PIO 1.
const struct dvi_timing __dvi_const(dvi_timing_800x600p_72hz) = {
    .h_sync_polarity   = true,
    .h_front_porch     = 56,
    .h_sync_width      = 120,
    .h_back_porch      = 64,
...
// Black scanline TMDS (DC-balanced black)
