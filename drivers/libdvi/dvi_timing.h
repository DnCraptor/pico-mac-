...
// Extended state enums for audio/data island support
...
// Extended chunk counts for audio/data island DMA lists
...
extern const struct dvi_timing dvi_timing_800x600p_72hz;
